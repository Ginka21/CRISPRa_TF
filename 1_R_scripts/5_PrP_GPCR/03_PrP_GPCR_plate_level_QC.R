...
pdf(file = file.path(output_dir, "Figures/GPCRa", "Quality metrics", "Quality metrics.pdf"),
...
png(filename = file.path(output_dir, "Figures/GPCRa", "Quality metrics", "Z_prime.png"),
...
png(filename = file.path(output_dir, "Figures/GPCRa", "Quality metrics", "SSMD.png"),
    width = plot_width, height = plot_height, units = "in", res = 600
    )
PlotSSMDControls(PrP_df)
dev.off()
