...
manuscript_dir <- file.path(output_dir, "Figures", "GPCRa", "Manuscript", "2) Component plots")
...
pdf(file = file.path(output_dir, "Figures", "GPCRa", "Histograms", "Histograms.pdf"),
...
for (i in seq_along(column_file_names)) {
  ...
  png(filename = file.path(output_dir, "Figures", "GPCRa", "Histograms", "PNGs", file_name),
